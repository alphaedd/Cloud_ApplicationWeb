...
# Build a Fullstack + Serverless Web App using AWS Amplify (Updated for 2025)

> **2025 Update:** This version of the workshop has been refreshed to use modern tooling and libraries, including **React 18**, **aws-amplify v6**, **@aws-amplify/ui-react v5** and **react-scripts 5**. The architecture sigue siendo serverless sobre **Amazon API Gateway**, **AWS Lambda**, **Amazon DynamoDB** y **Amazon S3**, pero las dependencias del frontend y del cliente de Amplify se han alineado con las mejores prácticas actuales.
